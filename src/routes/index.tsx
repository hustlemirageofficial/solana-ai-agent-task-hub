...
function AgentVisual() {
  return <div className="relative mx-auto aspect-[4/3] w-full max-w-[620px] overflow-hidden rounded-[2rem] border border-white/10 bg-[#040914] shadow-2xl shadow-black/70 ring-1 ring-violet-400/[0.08]">
    <div aria-hidden className="agent-wave absolute inset-0" />
    <div aria-hidden className="absolute inset-0 bg-[radial-gradient(circle_at_50%_52%,rgba(124,58,237,.18),transparent_28%),radial-gradient(circle_at_50%_60%,rgba(20,241,149,.1),transparent_44%)]" />
    <div aria-hidden className="absolute inset-0 opacity-30 [background-image:linear-gradient(rgba(148,163,184,.045)_1px,transparent_1px),linear-gradient(90deg,rgba(148,163,184,.045)_1px,transparent_1px)] [background-size:48px_48px]" />
    <div className="relative flex h-full flex-col items-center justify-center px-5 py-8">
      ...
      <div className="relative mt-2 h-52 w-52 sm:h-64 sm:w-64">
        <div aria-hidden className="absolute inset-0 rounded-full border border-violet-300/15 agent-pulse" />
        <div aria-hidden className="absolute inset-7 rounded-full border border-emerald-300/10 agent-pulse [animation-delay:1.1s]" />
        <div className="absolute left-1/2 top-1/2 h-32 w-28 -translate-x-1/2 -translate-y-1/2 rounded-[2rem] border border-white/15 bg-[#0a1220]/95 shadow-[0_0_55px_rgba(124,58,237,.28)] backdrop-blur-xl sm:h-40 sm:w-36">
          <div className="absolute -top-4 left-1/2 h-5 w-16 -translate-x-1/2 rounded-full border border-violet-300/20 bg-[#0c1423]" />
          <div className="absolute left-1/2 top-7 flex h-16 w-20 -translate-x-1/2 items-center justify-center rounded-2xl border border-violet-300/15 bg-[#070d18] shadow-inner sm:top-9 sm:h-20 sm:w-24"><div className="flex gap-3"><span className="h-3 w-3 rounded-full bg-violet-300 shadow-[0_0_16px_rgba(196,181,253,.9)]" /><span className="h-3 w-3 rounded-full bg-teal-300 shadow-[0_0_16px_rgba(94,234,212,.9)]" /></div></div>
          <div className="absolute bottom-5 left-1/2 h-1.5 w-12 -translate-x-1/2 rounded-full bg-slate-500/50" />
      ...
      <div className="relative -mt-5 h-20 w-52 sm:w-60"><div className="absolute left-1/2 top-0 h-12 w-28 -translate-x-1/2 rotate-[-4deg] rounded-lg border border-emerald-300/20 bg-gradient-to-br from-[#142132] to-[#08101c] shadow-[0_15px_40px_rgba(20,241,149,.12)]" /><div className="absolute left-1/2 top-2 -translate-x-1/2 text-2xl font-black text-white/80">S</div><div className="absolute left-1/2 top-14 h-1 w-24 -translate-x-1/2 rounded-full bg-emerald-300/30 blur-sm" /></div>
      <div className="mt-2 flex items-center gap-3 rounded-xl border border-white/10 bg-black/35 px-4 py-3 backdrop-blur-xl"><span className="h-2 w-2 animate-pulse rounded-full bg-emerald-300" /><span className="text-[10px] font-semibold uppercase tracking-[.16em] text-slate-400">Task escrow</span><span className="font-mono text-sm font-bold text-white">2.50 SOL</span><span className="text-[10px] font-bold text-emerald-300">LOCKED</span></div>
      <p className="mt-4 text-[9px] font-semibold uppercase tracking-[.24em] text-slate-600">AUTONOMOUS WORK · VERIFIED SETTLEMENT</p>
    </div>
    <style>{`@keyframes agentWave{0%,100%{opacity:.35;transform:scale(1)}50%{opacity:.95;transform:scale(1.08)}}@keyframes agentPulse{0%,100%{opacity:.25;transform:scale(.94)}50%{opacity:.75;transform:scale(1.04)}}.agent-wave{background:radial-gradient(circle at 50% 55%,rgba(124,58,237,.28),transparent 30%),radial-gradient(circle at 50% 70%,rgba(20,241,149,.18),transparent 46%);filter:blur(18px);animation:agentWave 5.5s ease-in-out infinite}.agent-pulse{animation:agentPulse 4.5s ease-in-out infinite}`}</style>
  </div>;
}
